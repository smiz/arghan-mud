...
To compile the mud you will need to get and possibly
build the adevs(https://github.com/smiz/adevs) simulation
library, which you will need to build, and the yaml-cpp
parser which you should be able to install with a package
manager. To build the library, go to the src director,
...
listed in room files are loaded from th 'monsters' directory.
